...
<p><input type="text" name="author" id="author" cols="8" value="<?php echo esc_attr($comment_author); ?>" size="22" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> /></p>

<label for="email"><small>Email:<span>*</span><?php _e(' (Will not be published)'); ?></small></label>
...
<label for="url"><small>Comments:<span>*</span></small></label>
<p><textarea name="comment" id="comment" cols="48" rows="5" tabindex="4"></textarea></p>

<?php do_action('bwp_recaptcha_add_markups'); ?>

<p><input name="submit" type="submit" id="submit" tabindex="5" value="<?php esc_attr_e('Submit'); ?>" />
